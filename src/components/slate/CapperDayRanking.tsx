  ...
  const inner = (
    <>
      ...
      <div className="min-w-0 flex-1 flex items-center gap-2">
        ...
        {/* xs badge is icon-only below sm, so the full handle still fits. */}
      ...
      {/* Mobile is too narrow for full handles plus this graded/total count
          (the section header already carries the slate totals), so it is
          desktop-only. */}
