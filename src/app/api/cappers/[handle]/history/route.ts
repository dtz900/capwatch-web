...
const VALID_SPORTS = new Set<SportFilter>(["all", "mlb", "nfl"]);
...
export async function GET(
  ...
  const spRaw = sp.get("sport") ?? "all";
  const sport = (VALID_SPORTS.has(spRaw as SportFilter) ? spRaw : "all") as SportFilter;
